...
- [x] 0.1 Im Feature-Worktree `pnpm add @fontsource/marcellus @fontsource/sora` ausführen
...
- [x] 1.1 Unit-Tests in einer neuen Theme-Suite (`tests/ui-theme.unit.test.ts`, Umgebung
...
- [x] 2.1 `src/client/app/theme.css` (neu) genau nach design.md: vier `@import`-Zeilen (D3),
...
- [x] 2.2 `src/client/main.tsx`: erste Import-Zeile `import './app/theme.css'` (D6); sonst
...
- [x] 3.3 Change nach `openspec/changes/archive/YYYY-MM-DD-add-ui-theme/` verschieben
